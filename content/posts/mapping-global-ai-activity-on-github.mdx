...
### [Regional Heatmap](/reports2/kepler_map_11.html)

<iframe src="/reports2/kepler_map_11.html" title="Kepler Map 11 - Regional Heatmap" width="100%" loading="eager" fetchpriority="high" allowFullScreen style={{ width: "100%", height: "min(760px, 95vh)", display: "block", border: "1px solid var(--border)", borderRadius: "8px" }}></iframe>
...
### [City User Points](/reports2/kepler_map_1.html)

<iframe src="/reports2/kepler_map_1.html" title="Kepler Map 1 - City User Points" width="100%" loading="lazy" allowFullScreen style={{ width: "100%", height: "min(760px, 95vh)", display: "block", border: "1px solid var(--border)", borderRadius: "8px" }}></iframe>
...
### [Country AI Activity](/reports2/kepler_map_7.html)

<iframe src="/reports2/kepler_map_7.html" title="Kepler Map 7 - Country AI Activity" width="100%" loading="lazy" allowFullScreen style={{ width: "100%", height: "min(760px, 95vh)", display: "block", border: "1px solid var(--border)", borderRadius: "8px" }}></iframe>
