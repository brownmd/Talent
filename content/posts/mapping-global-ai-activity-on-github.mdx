---
title: "Mapping Global AI Activity on GitHub"
date: "2026-05-13"
draft: false
...
Explore where AI Talent is located around the world. Using real data from The GitHub Archive Project hosted on Google's big query, we are able to dive into free open public data and build talent density insights. This report tracks public AI activity from users on GitHub, an online platform where developers store, and collaborate on software code. From infrastructure level contributors to the repo users star to follow, we will walk you through talent density hotspots around the world.
We were able to identify 5.81M monthly activity records on GitHub from 2.58M unique users with resolved locations, this report reveals where public GitHub users with AI technology activity is located from 2021 through March of 2026.
...
<iframe src="/reports/kepler_map_11.html" title="Kepler Map 11 - Regional Heatmap" width="100%" loading="eager" fetchpriority="high" allowFullScreen style={{ width: "100%", height: "min(760px, 95vh)", display: "block", border: "1px solid var(--border)", borderRadius: "8px" }}></iframe>
...
**For talent acquisition teams:** The differentiator can be access to data, and having time and resources to synthesize external market signals to build evidence based guidance. These insights may be the key to how impactful and the value tomorrow's Talent Acquisition brings to organizational success.