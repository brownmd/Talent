...
This report tracks verified public AI activity on GitHub: from infrastructure level contributors to the repo users star to follow, through the talent density hotspots around the world, and interesting visuals to accent raw data for interesting data consumption.

Based on 5.81M monthly activity records on GitHub of 2.58M unique users with resolved locations, this dataset reveals where public GitHub users with AI technology activity is located from 2021 through March of 2026.
...
This dataset measures **public AI activity** on GitHub (not self-reported skills), with partial coverage due to private repos, archived accounts, bot filtering, and API timing constraints.
...
**For talent acquisition teams:** The differentiator can be access to data, and having time and resources to synthesize external market signals to build evidence based guidance. These insights may be the key to how impactful and the value tomorrow's Talent Acquisition brings to organizational success and the employment of internal TA.

## The methodology

Using The GitHub Archive Project hosted on Google's big query which stores public GitHub activity daily since 2012. I was able to query the free dataset and extract user information.