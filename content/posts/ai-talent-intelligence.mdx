...
This dataset measures **public, behavioral AI activity** on GitHub (not self-reported skills), with partial coverage due to private repos, archived accounts, bot filtering, and API timing constraints.
Geographic resolution is limited to 322,868 users (11%) at country level and 235,054 (9%) at city level, and scores reflect observed contribution behavior rather than skill or project quality.
